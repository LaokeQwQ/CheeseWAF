...
cleanup 对象记录 runtime_removed、processes_stopped、source_template_unchanged 和 tracked_worktree_unchanged。产物扫描检查目录、tar.gz/zip 成员、符号链接与路径边界；不存在可扫描产物时也失败，避免空目录假绿。
