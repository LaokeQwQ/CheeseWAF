  ...
  return (
    <section className="system-fieldset time-sync-fieldset">
      <header className="fieldset-header-action time-sync-header">
        <div>
          <strong><Clock3 size={15} /> {t('system.timeSync')}</strong>
      ...
      <dl className="time-sync-status-grid" aria-label={t('system.timeSyncRuntimeStatus')}>
        ...
        <StatusItem label={t('system.timeSyncConsecutiveFailures')} value={status ? String(status.consecutive_failures) : '--'} />
        <StatusItem label={t('system.timeSyncTotalFailures')} value={status ? String(status.total_failures) : '--'} />
      </dl>
