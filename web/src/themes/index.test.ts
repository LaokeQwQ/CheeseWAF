...
describe('theme bootstrap', () => {
  ...
  it('applies matching document data-theme and color schemes', () => {
    applyTheme('dark');
    ...
    expect(document.documentElement.getAttribute('data-theme')).toBe('black-gold');
    expect(document.documentElement.style.colorScheme).toBe('dark');

    applyTheme('blueWhite');
    expect(document.documentElement.dataset.theme).toBe('blue-white');
    expect(document.documentElement.getAttribute('data-theme')).toBe('blue-white');
    expect(document.documentElement.style.colorScheme).toBe('light');

    applyTheme('pinkWhite');
    expect(document.documentElement.dataset.theme).toBe('pink-white');
    expect(document.documentElement.getAttribute('data-theme')).toBe('pink-white');
    expect(document.documentElement.style.colorScheme).toBe('light');
  });
