...
describe('BehaviorCaptcha responses',()=>{
  ...
  it.each([
    ['curve_draw','curve-draw-surface'],['curve_slider','curve-slider-foreground'],['rotate','rotate-puzzle-challenge'],['angle','angle-challenge'],['restore_slider','restore-slider-challenge'],
