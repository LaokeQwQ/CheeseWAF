...
func NewRouter(opts Options) http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.With(require("use:ai"), require("read:logs"), aiUseLimit).Post("/ai/analyze/stream", h.AnalyzeLogStream)
			r.With(require("use:ai"), require("read:logs"), aiUseLimit).Post("/ai/events/analyze", h.AnalyzeEvents)
			r.With(require("use:ai"), require("read:logs"), aiUseLimit).Post("/ai/events/analyze/stream", h.AnalyzeEventsStream)
