	...
	return []TemplateInfo{
		{
			ID:          "minimal",
			Name:        "Operational",
			Description: "Polished responsive block page with event details and Event / Trace ID.",
...
<body><main><span class="eyebrow">CheeseWAF protected this site</span><h1>Access was blocked</h1><p>{{if .Message}}{{.Message}}{{else}}This request matched an active security rule. Contact the site operator with the Event / Trace ID if you need help.{{end}}</p><div class="grid"><div class="box"><span class="label">Event / Trace ID</span><code class="value">{{.EventID}}</code></div><div class="box"><span class="label">Status</span><span class="value">{{.Status}} {{.StatusText}}</span></div><div class="box"><span class="label">Type</span><span class="value">{{.AttackType}}</span></div><div class="box"><span class="label">Client</span><span class="value">{{.ClientIP}}</span></div></div></main></body></html>`,
		},
		{
			ID:          "technical",
			Name:        "Technical",
