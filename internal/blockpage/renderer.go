  ...
  <main>
    <section class="hero">
      ...
      <div>
        ...
        <p class="lead">{{if .Message}}{{.Message}}{{else}}CheeseWAF matched this request against an active protection rule. If you believe this was a mistake, share the Trace ID with the site operator.{{end}}</p>
      </div>
      <footer>This response was generated by CheeseWAF. The Trace ID below maps to the security event stored by the WAF.</footer>
    </section>
